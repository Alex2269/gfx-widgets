...
int main(void) {
    ...
    gfx_open(W, H, "GFX Slider Knob Diamond");
    ...
    while(1) {
        ...
        Gui_SliderKnobDiamond_GFX(0, 100, 50, 10, 260, TerminusBold18x10_font, spacing,
                                  "tLeft1", NULL, &values[0], 250.0f, -250.0f, true, 0xFFFF00);
        Gui_SliderKnobDiamond_GFX(1, 200, 50, 10, 260, TerminusBold18x10_font, spacing,
                                  "tLeft2", "tRight2", &values[1], -250.0f, 250.0f, true, 0x00FF00);
        Gui_SliderKnobDiamond_GFX(2, 300, 50, 10, 260, TerminusBold18x10_font, spacing,
                                  "tLeft3", "tRight3", &values[2], 250.0f, -250.0f, true, 0xFF0000);
        Gui_SliderKnobDiamond_GFX(3, 400, 50, 10, 260, TerminusBold18x10_font, spacing,
